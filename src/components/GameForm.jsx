					...
					<div className='flex flex-col w-full gap-2'>
						...
						<div className='flex flex-col h-full'>
							...
							<textarea
								...
								id={id + '_description'}
								className={
									'border-zinc-400 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm mt-1 block w-full h-40 resize-none ' + (disabled ? 'bg-zinc-400' : 'bg-zinc-100')
								}
								value={description}
								disabled={disabled}
