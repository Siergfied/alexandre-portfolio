...
export default function Carousel({ array, carouselIndex, setCarouselIndex, children }) {
	...
	const buttonStyle =
		'flex justify-center items-center gap-4 lg:w-12 w-8 lg:h-12 h-8 bg-[#8759B4] hover:bg-[#9369bb] active:bg-[#9f7ac3] transition ease-in-out duration-250 rounded ';
	...
	return (
		<>
			...
			<>
				<div className='absolute lg:pl-4 pl-2 flex h-full items-center left-0'>
				...
				<div className='absolute lg:pr-4 pr-2 flex h-full items-center right-0'>
